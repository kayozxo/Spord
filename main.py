...
class App:
    def __init__(self, root):
        ...
        self.register_label = ctk.CTkLabel(
            self.register_frame, text="Register", font=("Montserrat Black", 24)
        )
        ...
        self.register_master_password = ctk.CTkEntry(
            self.register_frame,
        ...
        self.login_label = ctk.CTkLabel(
            self.login_frame, text="Login", font=("Montserrat Black", 24)
        )
        ...
        self.login_master_password = ctk.CTkEntry(
            self.login_frame,
            placeholder_text="Master Password",
            show="•",
            font=("Montserrat", 12),
        ...
        self.main_label = ctk.CTkLabel(
            self.main_frame, text="Password Manager", font=("Montserrat Black", 24)
        )
        ...
        self.get_password_button = ctk.CTkButton(
            self.main_frame,
            text="Get Password",
        ...
        self.how_label = ctk.CTkLabel(
            self.main_frame,
            text="To get a password, enter the website name and then click on 'Get Password' button",
    ...
    def register(self):
        ...
        if username == "" or master_password == "":
            CTkMessagebox(
                ...
                title="Error",
                icon="warning.png",
                message="Please enter both username and master password",
                font=("Montserrat Medium", 12),
                icon_size=(40, 40),
            )
            ...
            CTkMessagebox(
                ...
                title="Error",
                icon="warning.png",
                message="Username and master password cannot be the same",
                font=("Montserrat Medium", 12),
                icon_size=(40, 40),
            )
        else:
    ...
    def login(self):
        ...
        try:
            ...
            CTkMessagebox(
                ...
                title="Error",
                icon="error.png",
                message="You have not registered. Please Do That!",
                font=("Montserrat Medium", 12),
                icon_size=(40, 40),
            )
    ...
    def view_websites(self):
        try:
            ...
            CTkMessagebox(
                ...
                title="Error",
                icon="error.png",
                message="You have not saved any passwords!",
                font=("Montserrat Medium", 12),
                icon_size=(40, 40),
            )
    ...
    def add_password(self):
        ...
        if website == "" or password == "":
            CTkMessagebox(
                ...
                title="Error",
                icon="warning.png",
                message="Please enter both website and password!",
                font=("Montserrat Medium", 12),
                icon_size=(40, 40),
            )
        else:
        ...
        for entry in data:
            if entry["website"] == website:
                decrypted_password = self.decrypt_password(
                    self.cipher, entry["password"]
                )
                CTkMessagebox(
                    master=self.main_frame,
                    icon="info.png",
                    title="Password",
                    message=f"Password For {website} : {decrypted_password}",
                    font=("Montserrat Medium", 12),
                    icon_size=(40, 40),
                )
                password_found = True
